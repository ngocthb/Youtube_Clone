...
function Header({ toggleSidebar, onSearchSubmit }) {
    ...
    <>
      <header>
        <div className="header__logo">
          <button className="header__logo-menu" onClick={toggleSidebar}>
            <svg
        ...
        <form className="header__search" onSubmit={(e) => handleSubmit(e)}>
          <div className="search-container">
            <input type="text" placeholder="Search" value={search} onChange={(e) => setSearch(e.target.value)} />
            {search !== "" && <button className="header__search-clear">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24px"
                viewBox="0 -960 960 960"
          ...
          <button type="submit" className="header__search-search" >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 -960 960 960"
          ...
          <button className="header__search-mic">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 -960 960 960"
        ...
        <div className="header__profile">
          <button className="header__profile-create">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 -960 960 960"
          ...
          <button className="header__profile-notifications">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 -960 960 960"
          ...
          <img
            src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/BB1msyCN.img"
            alt="profile"
          />
        </div>
      </header>
