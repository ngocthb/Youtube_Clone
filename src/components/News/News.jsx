...
function News() {
    const sports = ["Featured News", "Sport", "Entertainment", "Business", "Technology", "World", "Domestic", "Science", "Health"];
    ...
    const videoGrid = useMemo(() => {
        return listVideos.map((video, index) => (
            <div key={index} className="video-card" onClick={() => handleClickVideo(video.id)}>
                <img src={video.snippet.thumbnails.standard.url} alt={video.snippet.title} className="video-thumbnail" />
                <div className="video-info">
                    <img src={video.channelThumbnail} alt={video.snippet.channelId} className="video-avatar" />
